  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="{{asset('login')}}">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="{{asset('img/zore.jpg')}}" class="img-circle" width="80"  height ="80"></a></p>
          <h5 class="centered">Yac ZORE</h5>
          <li class="mt">
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Zore</strong>. Tout Droit Reserve
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Created by Zore ContactS: (+226)72080667 <a href="https://templatemag.com/">yacoubazore9@gmail.com</a>
        </div>
